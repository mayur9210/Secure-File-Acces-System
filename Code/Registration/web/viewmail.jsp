<%-- 
    Document   : mailview
    Created on : Mar 23, 2013, 1:58:17 PM
    Author     : santosh
--%>
            ...
            <form name="f1">
                ...
                <th><input type="text" name="t2" value="<%=f2%>"></th> 
                 ...
                 <th><input type="text" name="t3" value="<%=f3%>"></th>
                  ...
                  <tr>
                      <input type="hidden" name="t10" value="<%=s1%>">
       <td> <input type="button" name="b1" value="forward" onclick="forward(this.form)"></td>
       <td>   <input type="button" name="b2" value="delete" onclick="delete1(this.form)"></td>
       <td>    <input type="button" name="b3" value="Reply" onclick="reply(this.form)"></td>
        </tr>
                </form>
        </center>         
